...
public class SkillsRequestHandler(
    IDictionaryRepository<int, SkillEntity, SkillResponse, DictionariesDataContext> dictionaryRepository)
    : MediatrDictionaryBase<SkillsRequest, int, SkillEntity, SkillResponse, DictionariesDataContext>(
